...
<img src="figuras/gitkraken.png" alt="criando seu repositório", width=500>
...
Seu repositório é como uma filogenia de arquivos: desde a origem, cada modificação fica registrada no ramo da árvore (cada commit é um fóssil), e o táxon terminal do ramo é o estado atual do repositório. Se quisermos reverter para um estado anterior, é só indicar qual fóssil quermos acessar:

Se quisermos reverter apenas um arquivo pro estado FOSSIL (onde FOSSIL é o hash do commit desejado)
