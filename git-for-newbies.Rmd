...
```
<img src="figuras/git_init.png" alt="criando seu repositório" width= "90%">
...
<img src="figuras/git_add.png" alt="criando seu repositório" width= "90%">
...
<img src="figuras/gitkraken.png" alt="criando seu repositório" width= "90%">
...
<img src="figuras/gitkraken-branch.png" alt="criando seu repositório" width= "90%">

***
Se criarmos um novo arquivo num ramo, ele só existirá nesse ramo:

<img src="figuras/git_branch.png" alt="criando seu repositório" width= "90%">
...
git merge master
```
<img src="figuras/git-merge-conflict.png" alt="criando seu repositório" width= "90%">
...
<img src="figuras/git-merge-conflict-content.png" alt="criando seu repositório" width= "90%">
...
Tudo que fizemos agora foi no repositório local, ou seja, no seu próprio computador. Git é descentralizado, isto é, cada pessoa tem seu repositório local, onde pode fazer suas alterações, e pode enviar essas alterações para um repositório externo. 

Por convenção, cada projeto tem pelo menos um repositório externo que serve como agregador do trabalho de todos os envolvidos, e como backup externo do projeto. Esse repositório é geralmente chamado `origin`, mas pode ter qualquer nome. 
Usaremos GitHub como repositório externo, pois ele permite repositórios privados gratuitos para estudantes.

***
No GitHub, clique em `New repository` para criar um novo ou em `ìmport repository` para copiar um que já existe em outro repositorio online

<img src="figuras/github-new.png" alt="criando seu repositório" width= "90%">

***
Escolha um nome para seu repositório, se ele vai ter `README`, `.gitignore` e um arquivo de licença

<img src="figuras/github-details.png" alt="criando seu repositório" width= "90%">

***
O repositório foi criado vazio, agora precisamos colocar nosso materiais nele. A isso chamamos de `push`. É só seguir as instruções do próprio GitHub:

<img src="figuras/github-empty-repo.png" alt="criando seu repositório" width= "90%">

***
<img src="figuras/github-add-remote.png" alt="criando seu repositório" width= "90%">

***
<img src="figuras/github-repo.png" alt="criando seu repositório" width= "90%">

***
Se quisermos copiar um repositório do github para nosso computador, podemos usar o comando git clone <img src="figuras/github-repo.png" alt="criando seu repositório" width= "90%">
